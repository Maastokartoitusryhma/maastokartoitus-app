...
const findSchemaObject = (objectKey: string, objectValue: any, schemaObject: BasicObject, componentArray: Array<any>) => {
  if (schemaObject) {
    switch (schemaObject['type']) {
      ...
      case 'integer':
      case 'string':
        componentArray.push(<SchemaObjectComponent name={objectKey} value={objectValue} schemaObject={schemaObject}></SchemaObjectComponent>)
        break
      case 'array':
        if (!schemaObject['title'] && Array.isArray(objectValue)) {
          ...
          componentArray.push(<SchemaObjectComponent name={objectKey} value={JSON.stringify(objectValue)} schemaObject={schemaObject}></SchemaObjectComponent>)
        }
        break
      case 'object':
    ...
    componentArray.push(<SchemaObjectComponent name={objectKey} value={JSON.stringify(objectValue)} schemaObject={null}></SchemaObjectComponent>)
  }
}